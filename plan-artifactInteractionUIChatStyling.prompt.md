...
6. Build artifact inspection: add `ArtifactComment` model in [llmHub/Models/UI/ArtifactTypes.swift](llmHub/Models/UI/ArtifactTypes.swift) (or a new model file), create [llmHub/Views/UI/Artifacts/ArtifactDetailView.swift](llmHub/Views/UI/Artifacts/ArtifactDetailView.swift), wire tap from [llmHub/Views/UI/Transcript/ArtifactCardView.swift](llmHub/Views/UI/Transcript/ArtifactCardView.swift) to a selection state + sheet presenter in [llmHub/Views/UI/RootView.swift](llmHub/Views/UI/RootView.swift), and implement comment submission to send a new user message via the existing send path in [llmHub/ViewModels/ChatViewModel.swift](llmHub/ViewModels/ChatViewModel.swift).
