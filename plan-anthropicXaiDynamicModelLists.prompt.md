...
1. Provider ID canonicalization:
   - Ensure persisted provider IDs map through `ProviderID.canonicalID(from:)` (already exists in [llmHub/Services/ProviderRegistry.swift](llmHub/Services/ProviderRegistry.swift)).
